...
\nwenddocs{}\nwbegincode{7}\moddef{pedigree-error}\plusendmoddef
...
\nwenddocs{}\nwbegincode{9}\moddef{pedigree-parent}\endmoddef
...
\nwenddocs{}\nwbegincode{11}\moddef{pedigree-create}\endmoddef
if (missing(famid))
...
\nwenddocs{}\nwbegincode{13}\moddef{pedigree-extra}\endmoddef
...
components except {\tt{}relation} will have the
same number of rows as the original data.

\subsection{Dimension}

Often times it is handy to be able to check or use the number of subjects. We want nrow to work on the pedigree object, but it dispatches to the dim() function for objects. We write dim to just return
the number of subjects and nrow will work. 

\nwenddocs{}\nwbegincode{15}\moddef{pedigree-dim}\endmoddef
...
{\tt{}x['joe']} is the first element of the vector, but
{\tt{}temp\ <-\ factor('joe',\ 'charlie',\ 'fred');\ z\ <-\ temp[1];\ x[z]\ } will
...
\end{enumerate}
\nwenddocs{}\nwbegincode{17}\moddef{pedigree-subscript}\endmoddef
...
\nwenddocs{}\nwbegincode{19}\moddef{pedigree-subscript}\plusendmoddef
...
\nwenddocs{}\nwbegincode{21}\moddef{as.data.frame.pedigree}\endmoddef
...
This function, similar to the one above, is useful for checking the pedigree object with the
...
\nwenddocs{}\nwbegincode{23}\moddef{ped2df}\endmoddef
...
\nwenddocs{}\nwbegincode{25}\moddef{print.pedigree}\endmoddef
...
\nwenddocs{}\nwbegincode{27}\moddef{notused}\endmoddef
...
\nwenddocs{}\nwbegincode{29}\moddef{kinship}\endmoddef
kinship <- function(id, ...) \{
    UseMethod('kinship')
    \}
...
A variable {\tt{}havemz} is set to TRUE if there are any, and an index array
{\tt{}mzindex} is created for matrix subscripting.

\nwenddocs{}\nwbegincode{31}\moddef{kinship}\plusendmoddef
...
family/subject.
\nwenddocs{}\nwbegincode{33}\moddef{kinship}\plusendmoddef
...
\nwenddocs{}\nwbegincode{35}\moddef{makekinship}\endmoddef
...
\nwenddocs{}\nwbegincode{37}\moddef{makemzindex}\endmoddef
...
\nwenddocs{}\nwbegincode{39}\moddef{makemzindex}\plusendmoddef
...
\nwenddocs{}\nwbegincode{41}\moddef{kinship}\plusendmoddef
...
\nwenddocs{}\nwbegincode{43}\moddef{autohint}\endmoddef
...
\nwenddocs{}\nwbegincode{45}\moddef{autohint-shift}\endmoddef
...
\nwenddocs{}\nwbegincode{47}\moddef{autohint-init}\endmoddef
if (!missing(hints)) \{
...
\nwenddocs{}\nwbegincode{49}\moddef{autohint-fixup}\endmoddef
\LA{}autohint-find\RA{}
...
\nwenddocs{}\nwbegincode{51}\moddef{autohint-fixup}\plusendmoddef
        # add the marriage(s)
...
\nwenddocs{}\nwbegincode{53}\moddef{autohint-duporder}\endmoddef
...
\nwenddocs{}\nwbegincode{55}\moddef{autohint-find}\endmoddef
...
\nwenddocs{}\nwbegincode{57}\moddef{autohint-find}\plusendmoddef
...
\begin{description}
  ...
  \item[fam] matrix, link upward to my parents, or 0 if no link.
\end{description}
\nwenddocs{}\nwbegincode{59}\moddef{align.pedigree}\endmoddef
...
\nwenddocs{}\nwbegincode{63}\moddef{align-founders}\endmoddef
...
\nwenddocs{}\nwbegincode{65}\moddef{align-finish}\endmoddef
#
...
\end{itemize}
\nwenddocs{}\nwbegincode{67}\moddef{align-finish}\plusendmoddef
if (!is.null(relation) && any(relation[,3] < 4)) \{
    twins <- 0* nid
    who  <- (relation[,3] <4)
...
\nwenddocs{}\nwbegincode{71}\moddef{alignped1}\endmoddef
...
\nwenddocs{}\nwbegincode{73}\moddef{alignped1}\plusendmoddef
...
\nwenddocs{}\nwbegincode{75}\moddef{alignped1}\plusendmoddef
...
trees.
\nwenddocs{}\nwbegincode{77}\moddef{alignped1}\plusendmoddef
...
only child.
\nwenddocs{}\nwbegincode{79}\moddef{alignped1}\plusendmoddef
    if (nokids) \{
        return(list(nid=nid, pos=pos, fam=fam, n=n, spouselist=spouselist))
        \}
...
\nwenddocs{}\nwbegincode{81}\moddef{alignped2}\endmoddef
...
\nwenddocs{}\nwbegincode{83}\moddef{alignped3}\endmoddef
...
\nwenddocs{}\nwbegincode{85}\moddef{align3-slide}\endmoddef
slide <- 0
for (i in 1:maxlev) \{
    n1 <- x1$n[i]
    n2 <- x2$n[i]
...
\nwenddocs{}\nwbegincode{87}\moddef{align3-merge}\endmoddef
for (i in 1:maxlev) \{
    n1 <- x1$n[i]
    n2 <- x2$n[i]
...
\nwenddocs{}\nwbegincode{89}\moddef{alignped4}\endmoddef
...
\nwenddocs{}\nwbegincode{91}\moddef{alignped4}\plusendmoddef
...
\nwenddocs{}\nwbegincode{93}\moddef{plot.pedigree}\endmoddef
...
\nwenddocs{}\nwbegincode{95}\moddef{pedplot-data}\endmoddef
if(is.null(status))
  status <- rep(0, n)
else \{
...
\nwenddocs{}\nwbegincode{97}\moddef{pedplot-data}\plusendmoddef
if(is.null(affected))\{
...
\nwenddocs{}\nwbegincode{99}\moddef{pedplot-sizing}\endmoddef
...
\nwenddocs{}\nwbegincode{101}\moddef{pedplot-sizing}\plusendmoddef
frame()
...
\nwenddocs{}\nwbegincode{103}\moddef{pedplot-symbols}\endmoddef
...
\nwenddocs{}\nwbegincode{105}\moddef{pedplot-lines}\endmoddef
...
\nwenddocs{}\nwbegincode{107}\moddef{pedplot-lines}\plusendmoddef
for(i in 2:maxlev) \{
...
\nwenddocs{}\nwbegincode{109}\moddef{pedplot-lines}\plusendmoddef
...
\nwenddocs{}\nwbegincode{111}\moddef{pedplot-finish}\endmoddef
...
\nwenddocs{}\nwbegincode{113}\moddef{pedplot-drawbox}\endmoddef
...
back to the center.
\nwenddocs{}\nwbegincode{115}\moddef{pedplot-circfun}\endmoddef
...
\nwenddocs{}\nwbegincode{117}\moddef{pedplot-polyfun}\endmoddef
...
\nwenddocs{}\nwbegincode{121}\moddef{pedplot-drawbox}\plusendmoddef
...
\nwenddocs{}\nwbegincode{123}\moddef{pedplot-subregion}\endmoddef
...
\nwenddocs{}\nwbegincode{125}\moddef{pedigree.legend}\endmoddef
...
\nwenddocs{}\nwbegincode{127}\moddef{pedigree.shrink}\endmoddef
...
\nwenddocs{}\nwbegincode{129}\moddef{pedigree.trim}\endmoddef
...
\nwenddocs{}\nwbegincode{133}\moddef{bitSize}\endmoddef
...
\nwenddocs{}\nwbegincode{135}\moddef{findAvailNonInform}\endmoddef
...
\nwenddocs{}\nwbegincode{137}\moddef{findAvailAffected}\endmoddef
...
\nwenddocs{}\nwbegincode{139}\moddef{pedigree.shrink.minor}\endmoddef
...
\nwenddocs{}\nwbegincode{141}\moddef{print.pedigree.shrink}\endmoddef
...
\nwenddocs{}\nwbegincode{143}\moddef{printBanner}\endmoddef
#$Log: printBanner.q,v $
...
\nwenddocs{}\nwbegincode{145}\moddef{plot.pedigree.shrink}\endmoddef
...
\nwenddocs{}\nwbegincode{147}\moddef{pedigree.unrelated}\endmoddef
...
skip a step.
\nwenddocs{}\nwbegincode{149}\moddef{kindepth}\endmoddef
...
\nwenddocs{}\nwbegincode{151}\moddef{kindepth}\plusendmoddef
...
\nwenddocs{}\nwbegincode{153}\moddef{familycheck}\endmoddef
...
\nwenddocs{}\nwbegincode{155}\moddef{check.hint}\endmoddef
