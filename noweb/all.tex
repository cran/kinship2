...
That is, the standard R approach is not what we want.
Our first solution was to create an integer vector with appropriate
name and subsctipt it, but a the above did it in when someone used an
element of a data frame as the index.

One question is what to do if the
family id is a numeric: when the user
...
\nwenddocs{}\nwbegincode{19}\moddef{ped2df}\endmoddef
...
\nwenddocs{}\nwbegincode{21}\moddef{print.pedigree}\endmoddef
...
\nwenddocs{}\nwbegincode{23}\moddef{kinship}\endmoddef
kinship <- function(id, ...) \{
    UseMethod('kinship')
    \}
...
\nwenddocs{}\nwbegincode{25}\moddef{kinship}\plusendmoddef
...
family/subject.
\nwenddocs{}\nwbegincode{27}\moddef{kinship}\plusendmoddef
...
\nwenddocs{}\nwbegincode{29}\moddef{makekinship}\endmoddef
...
values.)  
\nwenddocs{}\nwbegincode{31}\moddef{autohint}\endmoddef
...
\nwenddocs{}\nwbegincode{33}\moddef{autohint-shift}\endmoddef
...
\nwenddocs{}\nwbegincode{35}\moddef{autohint-init}\endmoddef
if (!missing(hints)) \{
...
\nwenddocs{}\nwbegincode{37}\moddef{autohint-fixup}\endmoddef
\LA{}autohint-find\RA{}
...
\nwenddocs{}\nwbegincode{39}\moddef{autohint-fixup}\plusendmoddef
        # add the marriage(s)
...
\nwenddocs{}\nwbegincode{41}\moddef{autohint-duporder}\endmoddef
...
\nwenddocs{}\nwbegincode{43}\moddef{autohint-find}\endmoddef
...
\nwenddocs{}\nwbegincode{45}\moddef{autohint-find}\plusendmoddef
...
\begin{description}
  ...
  \item[fam] matrix, link upward to my parents, or 0 if no link.
\end{description}
\nwenddocs{}\nwbegincode{47}\moddef{align.pedigree}\endmoddef
...
\nwenddocs{}\nwbegincode{51}\moddef{align-founders}\endmoddef
...
\nwenddocs{}\nwbegincode{53}\moddef{align-finish}\endmoddef
#
...
\end{itemize}
\nwenddocs{}\nwbegincode{55}\moddef{align-finish}\plusendmoddef
if (!is.null(relation) && any(relation[,3] < 4)) \{
    twins <- 0* nid
    who  <- (relation[,3] <4)
...
\nwenddocs{}\nwbegincode{59}\moddef{alignped1}\endmoddef
...
\nwenddocs{}\nwbegincode{63}\moddef{alignped1}\plusendmoddef
...
trees.
\nwenddocs{}\nwbegincode{65}\moddef{alignped1}\plusendmoddef
...
only child.
\nwenddocs{}\nwbegincode{67}\moddef{alignped1}\plusendmoddef
    if (nokids) \{
        return(list(nid=nid, pos=pos, fam=fam, n=n, spouselist=spouselist))
        \}
...
\nwenddocs{}\nwbegincode{69}\moddef{alignped2}\endmoddef
...
\nwenddocs{}\nwbegincode{71}\moddef{alignped3}\endmoddef
...
\nwenddocs{}\nwbegincode{73}\moddef{align3-slide}\endmoddef
slide <- 0
for (i in 1:maxlev) \{
    n1 <- x1$n[i]
    n2 <- x2$n[i]
...
\nwenddocs{}\nwbegincode{75}\moddef{align3-merge}\endmoddef
for (i in 1:maxlev) \{
    n1 <- x1$n[i]
    n2 <- x2$n[i]
...
\nwenddocs{}\nwbegincode{77}\moddef{alignped4}\endmoddef
...
\nwenddocs{}\nwbegincode{79}\moddef{alignped4}\plusendmoddef
...
\nwenddocs{}\nwbegincode{81}\moddef{plot.pedigree}\endmoddef
...
\nwenddocs{}\nwbegincode{83}\moddef{pedplot-data}\endmoddef
if(is.null(status))
  status <- rep(0, n)
else \{
...
\nwenddocs{}\nwbegincode{85}\moddef{pedplot-data}\plusendmoddef
if(is.null(affected))\{
...
\nwenddocs{}\nwbegincode{87}\moddef{pedplot-sizing}\endmoddef
...
\nwenddocs{}\nwbegincode{89}\moddef{pedplot-sizing}\plusendmoddef
frame()
...
\nwenddocs{}\nwbegincode{91}\moddef{pedplot-symbols}\endmoddef
...
\nwenddocs{}\nwbegincode{93}\moddef{pedplot-lines}\endmoddef
...
\nwenddocs{}\nwbegincode{95}\moddef{pedplot-lines}\plusendmoddef
for(i in 2:maxlev) \{
...
\nwenddocs{}\nwbegincode{97}\moddef{pedplot-lines}\plusendmoddef
...
\nwenddocs{}\nwbegincode{99}\moddef{pedplot-finish}\endmoddef
...
\nwenddocs{}\nwbegincode{101}\moddef{pedplot-drawbox}\endmoddef
...
back to the center.
\nwenddocs{}\nwbegincode{103}\moddef{pedplot-circfun}\endmoddef
...
\nwenddocs{}\nwbegincode{105}\moddef{pedplot-polyfun}\endmoddef
...
\nwenddocs{}\nwbegincode{107}\moddef{pedplot-polyfun}\plusendmoddef
...
\nwenddocs{}\nwbegincode{109}\moddef{pedplot-drawbox}\plusendmoddef
...
\nwenddocs{}\nwbegincode{111}\moddef{pedplot-subregion}\endmoddef
...
\nwenddocs{}\nwbegincode{113}\moddef{pedigree.legend}\endmoddef
...
\nwenddocs{}\nwbegincode{115}\moddef{pedigree.shrink}\endmoddef
...
\nwenddocs{}\nwbegincode{117}\moddef{pedigree.trim}\endmoddef
...
\nwenddocs{}\nwbegincode{119}\moddef{findUnavailable}\endmoddef
...
\nwenddocs{}\nwbegincode{121}\moddef{bitSize}\endmoddef
...
\nwenddocs{}\nwbegincode{123}\moddef{findAvailNonInform}\endmoddef
...
\nwenddocs{}\nwbegincode{125}\moddef{findAvailAffected}\endmoddef
...
\nwenddocs{}\nwbegincode{127}\moddef{pedigree.shrink.minor}\endmoddef
...
\nwenddocs{}\nwbegincode{129}\moddef{print.pedigree.shrink}\endmoddef
...
\nwenddocs{}\nwbegincode{131}\moddef{printBanner}\endmoddef
#$Log: printBanner.q,v $
...
\nwenddocs{}\nwbegincode{133}\moddef{plot.pedigree.shrink}\endmoddef
...
\nwenddocs{}\nwbegincode{135}\moddef{pedigree.unrelated}\endmoddef
...
skip a step.
\nwenddocs{}\nwbegincode{137}\moddef{kindepth}\endmoddef
...
\nwenddocs{}\nwbegincode{139}\moddef{kindepth}\plusendmoddef
...
\nwenddocs{}\nwbegincode{141}\moddef{familycheck}\endmoddef
...
\nwenddocs{}\nwbegincode{143}\moddef{check.hint}\endmoddef
